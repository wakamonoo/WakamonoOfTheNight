    ...
    <>
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          <Image
            src={Work1}
            alt="project"
            className="w-[8rem] sm:w-[11rem] h-auto rounded"
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">FIRSTRESPONSE</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
              First aid and emergency response application for the 3rd District
              of Albay, Bicol Region.
            </p>
            <div className="flex gap-2 mt-2 text-2xl sm:text-3xl text-normal">
              <SiKotlin />
              <SiFirebase />
            </div>
          </div>
        ...
        <div className="flex justify-center">
          <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
            <a href="">
              <button className="text-center font-normal text-sm sm:text-xl p-2 sm:p-4 bg-panel rounded text-normal w-[15rem]">
                Commence Operation
              </button>
            </a>
            <a href="">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">REVVED</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">ANCESTORY</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">SORA</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">DEBTFLIX</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">KANDILI</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">TODOCHAN</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">POINTCITY</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">RINA</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
      ...
      <div className="p-4 sm:p-8 bg-brand w-full h-full rounded">
        <div className="flex justify-between">
          ...
          />
          <div className="w-full ml-2 sm:ml-4">
            <h4 className="text-xl sm:text-3xl text-header">616-INITIATIVE</h4>
            <p className="text-sm sm:text-xl leading-4 sm:leading-5.5 sm:mt-2  text-normal">
