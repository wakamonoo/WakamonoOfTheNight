    ...
    <main>
      ...
      <section id="skills" className="bg-second p-8 sm:p-15 md:p-24 lg:p-32 xl:px-72">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-4 gap-2 md:gap-4">
            <div
              tabIndex="0"
              className="p-2 md:p-4 text-5xl sm:text-7xl md:text-8xl text-normal bg-brand rounded transition-all duration-300 hover:scale-110 hover:text-[var(--color-accent)] active:scale-110 focus:text-[var(--color-accent)]"
            >
              <SiHtml5 />
            </div>
            <div
